...
def create_movie():
    ...
    movie_repository.create_movie(movie_name, director_name, rating)
...
def search_movies():
    ...
    return render_template('search_movies.html', search_active=True, search_results=search_results)
